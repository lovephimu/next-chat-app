...
export default function Chat() {
  ...
  return (
    <section className="flex p-4 flex-grow flex-col self-end w-full justify-end h-[85dvh] max-h-[85dvh] sm:max-h-[70dvh] sm:h-full sm:max-w-2xl sm:px-8 sm:pb-8 sm:pt-0">
      {messages.length === 0 ? (
